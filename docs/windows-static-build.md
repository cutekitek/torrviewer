...
This project has a Windows-only static profile that builds a custom FFmpeg first, then builds bundled static `libmpv`, `libtorrent-rasterbar`, and ThorVG through Meson subprojects.
